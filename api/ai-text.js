// Vercel serverless function — AI text generation for KBT tools (v2)
// Fixed: crack-code phonetics, face-morph 3 clues, ghost-actors, host-brief, soundmash
...
export default async function handler(req, res) {
  ...
  if (!promptFn) return res.status(400).json({ error: `Unknown tool: ${tool}. Valid tools: ${Object.keys(PROMPTS).join(', ')}` });
