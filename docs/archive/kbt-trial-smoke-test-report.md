...
The handover lists your actual 9 KBT venues (Ascot Vale Hotel Mon, Spotswood Hotel Tue, Mona Castle Tue, 388 Sports Bar Tue, Cross Keys Tue, Steam Packet Wed, Hotel Trentham Thu, The Cheeky Pint Thu, Stags Head Sat). These should replace the fake list — especially before the trial goes in front of a real player.
